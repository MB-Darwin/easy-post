...
import { NewProject } from "@/entities/project/schemas";
...
export async function GET(
  ...
  try {
    ...
    const project = await projectService.findById(company.id, params.id);
...
export async function DELETE(
  ...
  try {
    ...
    await projectService.delete(company.id, params.id);
