  ...
  "inline-flex items-center justify-center whitespace-nowrap font-medium ring-offset-background transition-[color,box-shadow] [&_svg]:shrink-0",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        color: "primary",
        className:
          "bg-primary-400 text-primary-950 dark:bg-primary-600 dark:text-primary-50",
      },
      {
        variant: "contained",
        color: "secondary",
      ...
      },
      {
        ...
        color: "success",
        className:
          "bg-success-400 text-success-950 dark:bg-success-600 dark:text-success-50",
      },
      {
        variant: "contained",
        color: "warning",
        className:
          "bg-warning-400 text-warning-950 dark:bg-warning-600 dark:text-warning-50",
      },
      {
        variant: "contained",
        color: "error",
        className:
          "bg-error-400 text-error-950 dark:bg-error-600 dark:text-error-50",
      },
      {
        variant: "contained",
        color: "info",
        className:
          "bg-info-400 text-info-950 dark:bg-info-600 dark:text-info-50",
      },
      ...
      },
      {
        ...
        color: "primary",
        className:
          "bg-primary-100 text-primary-600 dark:bg-primary-900 dark:text-primary-600",
      },
      {
        variant: "soft",
        color: "secondary",
      ...
      },
      {
        ...
        color: "success",
        className:
          "bg-success-100 text-success-600 dark:bg-success-900 dark:text-success-600",
      },
      {
        variant: "soft",
        color: "warning",
      ...
      },
      {
        ...
        color: "error",
        className:
          "bg-error-100 text-error-600 dark:bg-error-900 dark:text-error-600",
      },
      {
        variant: "soft",
        color: "info",
        className:
          "bg-info-100 text-info-600 dark:bg-info-900 dark:text-info-600",
      },
